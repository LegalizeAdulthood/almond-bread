...
void
FractMain(argc, argv, appInitProc)
					 ...
					 * to execute commands. */
{
    ...
    /* AlmondBread initialization */
    if(Tcl_Eval(interp, "wm title . Image; . conf -bg black; update idletasks; raster .r -width [winfo width .] -height [winfo height .]; pack .r; update idletasks;")!=TCL_OK)
      goto error;
    InstallTraces(interp);
    SetDefaultInfo();
